      ...
      child: Column(
        ...
        children: [
          ...
          CustomButton(
            text: 'Generate PIN',
            onPressed: () {
              context.read<LiveVitalsCubit>().resetCopyState();

              // بنروح للشاشة الجديدة وبنبعت الكيوبت في الـ extra
              GoRouter.of(context).push(
                AppRouter.kSecurityPinView,
                extra: context.read<LiveVitalsCubit>(),
              );
            },
          ),
        ],

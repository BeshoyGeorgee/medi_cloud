...
class HealthConditionsList extends StatelessWidget {
  ...
  const HealthConditionsList({super.key, required this.conditions, required this.onChanged, required this.onRemove});
        ...
        return Padding(
          ...
          child: Row(
            children: [
              ...
              if (!["Diabetes", "Hypertension", "Smoker"].contains(condition))
                IconButton(
